#!/usr/bin/env python3
"""
Hacktivity Menu Bar App
A menu bar application for quick access to Hacktivity scripts
"""
...
class HacktivityApp(rumps.App):
    def __init__(self):
        super(HacktivityApp, self).__init__("📊", title="Hacktivity")
        
        # Set up paths
        self.script_dir = Path(__file__).parent
        self.log_file = Path.home() / "Desktop" / "hacktivity_log.txt"
        self.report_file = Path.home() / "Desktop" / "hacktivity_report.txt"
